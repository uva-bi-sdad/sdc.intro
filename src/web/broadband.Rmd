...
![](img/broadband-avgdown.png){width="600px" class="story_image"}
...
![](img/broadband-hhbb.png){width="600px" class="story_image"}
...
<div style="float: right;">
![](img/broadband-percinc.png){width="600px" class="story_image"}
