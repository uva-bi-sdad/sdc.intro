...
<table>
  <tr>
    <td>
    <h4>By creating new <b>below county-level datasets and measures</b> derived from publicly collectible data sources, we provide <b>actionable data for local-level decision-making</b>. We aim to <b>inform equitable and sustainable growth</b> in Virginia and the National Capital Region.</h4>
    </td>
  </tr>
  <tr>
...
-   addresses local issues of concern (food insecurity and equity, for example)
  ...
  <tr>
    ...
    <hr />
    Sponsored by<br />
    <img src="img/partners-mclogo.png" height="50px">
    </td>
  </tr>
  <tr>
