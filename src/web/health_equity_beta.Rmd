...
![](img/tutorial-filter_menu.png){width="400px"}
<li> In the Filter Window under "county" select "Arlington County" and "Fairfax County"
![](img/tutorial-filter_menu_counties.png){width="400px"}
...
![](img/tutorial-outline_weight.png){width="400px"}
...
![](img/tutorial-export.png){width="400px"}
</ol>
</span>
</figcaption>
</div>
...
data <- read.csv(url, na.strings = c("NA", "null"))
