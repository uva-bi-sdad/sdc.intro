...
### We use our **Community Learning Through Data Driven Discovery (CLD3)** framework to drive the construction of the Social Impact Data Commons. Our initial grounding in **specific, local issues** is developed in partnership with communitiy stakeholders in Arlington and Fairfax Counties in Virginia.
...
* equity and Stability of Access to Staple Foods, and
* transforming Racial Equity Data into Meaningful Geographies

### Data collection

After grounding in local issues, we collected data from a variety of sources to create novel measures and datasets. 
